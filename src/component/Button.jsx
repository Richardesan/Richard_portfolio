...
const EncryptButton = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative overflow-hidden  border-[1px] border-neutral-500 bg-neutral-700 px-4 py-2 font-mono font-medium uppercase text-neutral-300 transition-colors hover:text-green-500"
    >
